...
(function () {
    ...
    var basicBot = {
        ...
        settings: {
            ...
            motdEnabled: true,
            motdInterval: 10,
            motd: "Nepamirskite asikviesti draugu",
            filterChat: true,
            ...
            if (basicBot.settings.welcome && greet) {
                welcomeback ?
                    setTimeout(function (user) {
                        API.sendChat(subChat(basicBot.chat.Sveikas Sugrizes, {name: user.username} i LietuvosDJ));
                    }, 1 * 1000, user)
                    :
                    setTimeout(function (user) {
                        API.sendChat(subChat(basicBot.chat.Sveikas Atvykes, {name: user.username} i LietuvosDJ));
                    }, 1 * 1000, user);
            }
        },
