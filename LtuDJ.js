...
(function () {
    ...
    /*window.onerror = function() {
        var room = JSON.parse(localStorage.getItem("LtuDJRoom"));
    ...
    var sendToSocket = function () {
        var LtuDJSettings = LtuDJ.settings;
        var LtuDJRoom = LtuDJ.room;
        var LtuDJInfo = {
            time: Date.now(),
            version: LtuDJ.version
        };
        var data = {users:API.getUsers(),userinfo:API.getUser(),room:location.pathname,LtuDJSettings:LtuDJSettings,LtuDJRoom:LtuDJRoom,LtuDJInfo:LtuDJInfo};
        return sock.msg(data);
    };*/

    var storeToStorage = function () {
        localStorage.setItem("LtuDJsettings", JSON.stringify(LtuDJ.settings));
        localStorage.setItem("LtuDJRoom", JSON.stringify(LtuDJ.room));
        var LtuDJStorageInfo = {
            time: Date.now(),
            stored: true,
            version: LtuDJ.version
        };
        localStorage.setItem("LtuDJStorageInfo", JSON.stringify(LtuDJStorageInfo));
    ...
    var retrieveSettings = function () {
        var settings = JSON.parse(localStorage.getItem("LtuDJsettings"));
        if (settings !== null) {
    ...
    var retrieveFromStorage = function () {
        var info = localStorage.getItem("LtuDJStorageInfo");
    ...
    var LtuDJ = {
        ...
        chatLink: "https://rawgit.com/ArcaZG/LtuDJ/master/lang/ltu.json",
        chat: null,
        loadChat: loadChat,
        ...
        settings: {
            ...
            commandLiteral: "!",
            blacklists: {
                NSFW: "https://rawgit.com/LtuDJ/custom/master/blacklists/NSFWlist.json",
                OP: "https://rawgit.com/LtuDJ/custom/master/blacklists/OPlist.json",
